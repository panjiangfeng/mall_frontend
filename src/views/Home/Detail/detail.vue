      ...
      <el-main>
        ...
        <div class="content">
          ...
          <div class="buy">
            ...
            <button class="addcartbtn" @click="addCart">
              添加购物车
            </button>
                ...
                >
                  <p>
                    欢迎学习交流，点赞和关注我的<a
                      ...
                      @click="newwindow('https://github.com/panjiangfeng')"
                  >GitHub</a
                  >，感激不尽!
                  </p>
                </el-drawer>
